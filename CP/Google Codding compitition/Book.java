...
public class Book {
    public static void main(String[] args) {
        try {
            ...
            FileInputStream fin = new FileInputStream("a_example.in");
            int i = 0;
            while ((i = fin.read()) != -1) {
            ...
            // int numberOfBooks = in.nextInt(); // Scanner has functions to read ints,
            ...
            // int signupDaysPassed = 0, numberOfSignupDaysNeeded = 0,
            // totalSignedUpLibraries = 0;
